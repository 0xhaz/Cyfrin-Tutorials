...
import { ContinueOnRevertHandler } from
    "test/Intermediate/Advanced/Stablecoins/fuzz/continueOnRevert/ContinueOnRevertHandler.t.sol";
...
contract ContinueOnRevertInvariants is StdInvariant, Test {
    ...
    function setUp() external {
        ...
        (ethUsdPriceFeed, btcUsdPriceFeed, weth, wbtc,) = helperConfig.activeNetworkConfigDSC();
